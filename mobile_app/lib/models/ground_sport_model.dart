...
class GroundSportModel {
  ...
  factory GroundSportModel.fromJson(Map<String, dynamic> json) => GroundSportModel(
        id:           json['id'] as int,
  ...
  static List<GroundSportModel> listFromJson(List<dynamic> list) =>
      list.map((e) => GroundSportModel.fromJson(e as Map<String, dynamic>)).toList();
